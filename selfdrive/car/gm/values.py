...
class CAR:
  ...
  ESCALADE_ESV_2017 = "CADILLAC ESCALADE ESV 2017"
...
DBC = {
  ...
  CAR.ESCALADE_ESV_2017: dbc_dict('gm_global_a_powertrain', 'gm_global_a_object', chassis_dbc='gm_global_a_chassis'),
}
